...
const Points = () => {
  ...
  return (
    <div className="min-h-screen pb-16 bg-gray-50">
      <header className="bg-gradient-to-r from-hero-primary to-hero-secondary text-white p-6">
        <h1 className="text-xl font-bold text-center mb-4">My Points</h1>
      ...
      <main className="max-w-md mx-auto p-4 space-y-6">
        ...
        <section>
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="text-hero-accent text-sm flex items-center">
              All Badges
              ...
              <div key={reward.id} className="hero-card flex overflow-hidden">
                ...
                <div className="p-3 flex-1">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center text-sm font-bold text-hero-primary">
